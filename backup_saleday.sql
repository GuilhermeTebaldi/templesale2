...
ALTER SCHEMA public OWNER TO saleday_user;
...
ALTER TABLE public.activity_logs OWNER TO saleday_user;
...
ALTER SEQUENCE public.activity_logs_id_seq OWNER TO saleday_user;
...
CREATE TABLE public.admin_visitor_self_signatures (
    id bigint NOT NULL,
...
ALTER TABLE public.admin_visitor_self_signatures OWNER TO saleday_user;

--
-- Name: admin_visitor_self_signatures_id_seq; Type: SEQUENCE; Schema: public; Owner: saleday_user
--

CREATE SEQUENCE public.admin_visitor_self_signatures_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE public.admin_visitor_self_signatures_id_seq OWNER TO saleday_user;

--
-- Name: admin_visitor_self_signatures_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: saleday_user
--

ALTER SEQUENCE public.admin_visitor_self_signatures_id_seq OWNED BY public.admin_visitor_self_signatures.id;
...
ALTER TABLE public.favorites OWNER TO saleday_user;
...
ALTER SEQUENCE public.favorites_id_seq OWNER TO saleday_user;
...
ALTER TABLE public.messages OWNER TO saleday_user;
...
ALTER SEQUENCE public.messages_id_seq OWNER TO saleday_user;
...
ALTER TABLE public.orders OWNER TO saleday_user;
...
ALTER SEQUENCE public.orders_id_seq OWNER TO saleday_user;
...
CREATE TABLE public.product_cart_notifications (
    id integer NOT NULL,
...
ALTER TABLE public.product_cart_notifications OWNER TO saleday_user;

--
-- Name: product_cart_notifications_id_seq; Type: SEQUENCE; Schema: public; Owner: saleday_user
--

CREATE SEQUENCE public.product_cart_notifications_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.product_cart_notifications_id_seq OWNER TO saleday_user;

--
-- Name: product_cart_notifications_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: saleday_user
--

ALTER SEQUENCE public.product_cart_notifications_id_seq OWNED BY public.product_cart_notifications.id;
...
ALTER TABLE public.product_comments OWNER TO saleday_user;
...
ALTER SEQUENCE public.product_comments_id_seq OWNER TO saleday_user;
...
ALTER TABLE public.product_likes OWNER TO saleday_user;
...
ALTER TABLE public.product_questions OWNER TO saleday_user;
...
ALTER SEQUENCE public.product_questions_id_seq OWNER TO saleday_user;
...
ALTER TABLE public.products OWNER TO saleday_user;
...
ALTER TABLE public.products_backup OWNER TO saleday_user;
...
ALTER SEQUENCE public.products_id_seq OWNER TO saleday_user;
...
ALTER TABLE public.remember_tokens OWNER TO saleday_user;
...
ALTER SEQUENCE public.remember_tokens_id_seq OWNER TO saleday_user;
...
ALTER TABLE public.reviews OWNER TO saleday_user;
...
ALTER SEQUENCE public.reviews_id_seq OWNER TO saleday_user;
...
ALTER TABLE public.sessions OWNER TO saleday_user;
...
ALTER SEQUENCE public.sessions_id_seq OWNER TO saleday_user;
...
ALTER TABLE public.site_daily_visitors OWNER TO saleday_user;

--
-- Name: site_daily_visitors_id_seq; Type: SEQUENCE; Schema: public; Owner: saleday_user
--

CREATE SEQUENCE public.site_daily_visitors_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE public.site_daily_visitors_id_seq OWNER TO saleday_user;

--
-- Name: site_daily_visitors_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: saleday_user
--

ALTER SEQUENCE public.site_daily_visitors_id_seq OWNED BY public.site_daily_visitors.id;
...
ALTER TABLE public.support_conversations OWNER TO saleday_user;
...
ALTER SEQUENCE public.support_conversations_id_seq OWNER TO saleday_user;
...
ALTER TABLE public.support_messages OWNER TO saleday_user;
...
ALTER SEQUENCE public.support_messages_id_seq OWNER TO saleday_user;
...
ALTER TABLE public.users_backup OWNER TO saleday_user;
...
ALTER SEQUENCE public.users_id_seq OWNER TO saleday_user;
...
ALTER TABLE ONLY public.admin_visitor_self_signatures ALTER COLUMN id SET DEFAULT nextval('public.admin_visitor_self_signatures_id_seq'::regclass);
...
ALTER TABLE ONLY public.product_cart_notifications ALTER COLUMN id SET DEFAULT nextval('public.product_cart_notifications_id_seq'::regclass);
...
ALTER TABLE ONLY public.site_daily_visitors ALTER COLUMN id SET DEFAULT nextval('public.site_daily_visitors_id_seq'::regclass);
...
COPY public.activity_logs (id, event_type, user_id, user_name, target_user_id, target_product_id, description, metadata, created_at, target_user_name) FROM stdin;
...
COPY public.admin_visitor_self_signatures (id, admin_email, signature_key, device_type, device_model, os_name, os_version, created_at, last_seen_at) FROM stdin;
...
COPY public.messages (id, sender_id, receiver_id, product_id, content, created_at, is_read) FROM stdin;
\.
...
COPY public.orders (id, product_id, seller_id, buyer_id, status, created_at, confirmed_at, updated_at, completed_at, total) FROM stdin;
\.
...
COPY public.product_cart_notifications (id, owner_user_id, actor_user_id, actor_name, product_id, created_at) FROM stdin;
...
COPY public.product_comments (id, product_id, user_id, parent_comment_id, rating, body, created_at) FROM stdin;
...
COPY public.product_likes (user_id, product_id, created_at) FROM stdin;
117	416	1773168995
117	380	1775050081
117	417	1780401785
\.
...
COPY public.product_questions (id, product_id, user_id, content, created_at, updated_at, response_content, response_user_id, response_created_at) FROM stdin;
\.
...
COPY public.products_backup (id, user_id, title, description, price, category, city, image_url, created_at, lat, lng, country, state, neighborhood, street, zip, status) FROM stdin;
...
COPY public.remember_tokens (id, user_id, token_hash, expires_at, created_at) FROM stdin;
...
COPY public.reviews (id, reviewee_id, reviewer_id, stars, comment, created_at, order_id, updated_at) FROM stdin;
\.
...
COPY public.site_daily_visitors (id, visit_date, visitor_key, ip, user_agent, entry_path, referrer, referrer_host, country, region, city, first_seen_at, last_seen_at, visits) FROM stdin;
...
COPY public.support_conversations (id, user_id, subject, status, created_at, updated_at, user_last_seen_message_id) FROM stdin;
...
COPY public.support_messages (id, conversation_id, sender_type, sender_id, content, created_at) FROM stdin;
...
COPY public.users_backup (id, username, email, phone, country, state, city, district, street, zip, password, created_at) FROM stdin;
...
SELECT pg_catalog.setval('public.activity_logs_id_seq', 899, true);
...
SELECT pg_catalog.setval('public.admin_visitor_self_signatures_id_seq', 37, true);
...
SELECT pg_catalog.setval('public.favorites_id_seq', 177, true);
...
SELECT pg_catalog.setval('public.messages_id_seq', 1085, true);
...
SELECT pg_catalog.setval('public.product_cart_notifications_id_seq', 9, true);
...
SELECT pg_catalog.setval('public.product_comments_id_seq', 10, true);
...
SELECT pg_catalog.setval('public.product_questions_id_seq', 70, true);
...
SELECT pg_catalog.setval('public.products_id_seq', 424, true);
...
SELECT pg_catalog.setval('public.remember_tokens_id_seq', 147, true);
...
SELECT pg_catalog.setval('public.site_daily_visitors_id_seq', 2189, true);
...
SELECT pg_catalog.setval('public.support_conversations_id_seq', 3, true);
...
SELECT pg_catalog.setval('public.support_messages_id_seq', 29, true);
...
ALTER TABLE ONLY public.admin_visitor_self_signatures
...
ALTER TABLE ONLY public.product_cart_notifications
...
ALTER TABLE ONLY public.site_daily_visitors
...
CREATE INDEX idx_admin_self_signatures_email_last_seen ON public.admin_visitor_self_signatures USING btree (admin_email, last_seen_at DESC);
...
CREATE UNIQUE INDEX idx_admin_self_signatures_unique ON public.admin_visitor_self_signatures USING btree (admin_email, signature_key);
...
CREATE INDEX idx_product_cart_notifications_owner_created ON public.product_cart_notifications USING btree (owner_user_id, created_at DESC);
...
CREATE INDEX idx_product_cart_notifications_product ON public.product_cart_notifications USING btree (product_id);
...
CREATE INDEX idx_product_cart_notifications_product_id ON public.product_cart_notifications USING btree (product_id);
...
CREATE INDEX idx_product_comments_parent ON public.product_comments USING btree (parent_comment_id);
...
CREATE INDEX idx_product_comments_product_created ON public.product_comments USING btree (product_id, created_at DESC);
...
CREATE UNIQUE INDEX idx_product_likes_user_product_unique ON public.product_likes USING btree (user_id, product_id);
...
CREATE INDEX idx_product_questions_product ON public.product_questions USING btree (product_id);
...
CREATE INDEX idx_product_questions_response_user ON public.product_questions USING btree (response_user_id);
...
CREATE INDEX idx_products_brand_ci ON public.products USING btree (lower(brand));
...
CREATE INDEX idx_products_color_ci ON public.products USING btree (lower(color));
...
CREATE INDEX idx_products_hidden_by_seller ON public.products USING btree (hidden_by_seller);
...
CREATE INDEX idx_products_last_clicked ON public.products USING btree (last_clicked_at DESC);
...
CREATE INDEX idx_products_last_viewed ON public.products USING btree (last_viewed_at DESC);
...
CREATE INDEX idx_products_lat ON public.products USING btree (lat);
...
CREATE INDEX idx_products_lat_lng ON public.products USING btree (lat, lng);
...
CREATE INDEX idx_products_lng ON public.products USING btree (lng);
...
CREATE INDEX idx_products_manual_rank_active ON public.products USING btree (manual_rank_position, manual_rank_expires_at DESC);
...
CREATE INDEX idx_products_metrics ON public.products USING btree (clicks_count DESC, views_count DESC);
...
CREATE INDEX idx_products_model_ci ON public.products USING btree (lower(model));
...
CREATE INDEX idx_products_rank ON public.products USING btree (rank DESC);
...
CREATE UNIQUE INDEX idx_reviews_order_id ON public.reviews USING btree (order_id) WHERE (order_id IS NOT NULL);
...
CREATE UNIQUE INDEX idx_site_daily_visitors_date_key ON public.site_daily_visitors USING btree (visit_date, visitor_key);
...
CREATE INDEX idx_site_daily_visitors_date_last_seen ON public.site_daily_visitors USING btree (visit_date, last_seen_at DESC);
...
CREATE INDEX idx_users_accepted_guidelines_at ON public.users USING btree (accepted_community_at);
...
CREATE INDEX idx_users_accepted_privacy_at ON public.users USING btree (accepted_privacy_at);
...
CREATE INDEX idx_users_accepted_terms_at ON public.users USING btree (accepted_terms_at);
...
CREATE INDEX idx_users_company_country ON public.users USING btree (company_country, company_state, company_city);
...
CREATE INDEX remember_tokens_user_idx ON public.remember_tokens USING btree (user_id);
...
CREATE UNIQUE INDEX uniq_orders_product_confirmed ON public.orders USING btree (product_id) WHERE (status = 'confirmed'::text);
...
CREATE UNIQUE INDEX users_auth0_sub_unique ON public.users USING btree (auth0_sub) WHERE (auth0_sub IS NOT NULL);
...
ALTER TABLE ONLY public.favorites
    ADD CONSTRAINT fk_fav_product FOREIGN KEY (product_id) REFERENCES public.products(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.messages
    ADD CONSTRAINT messages_product_id_fkey FOREIGN KEY (product_id) REFERENCES public.products(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.product_cart_notifications
    ADD CONSTRAINT product_cart_notifications_actor_user_id_fkey FOREIGN KEY (actor_user_id) REFERENCES public.users(id) ON DELETE SET NULL;
...
ALTER TABLE ONLY public.product_cart_notifications
    ADD CONSTRAINT product_cart_notifications_owner_user_id_fkey FOREIGN KEY (owner_user_id) REFERENCES public.users(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.product_cart_notifications
    ADD CONSTRAINT product_cart_notifications_product_id_fkey FOREIGN KEY (product_id) REFERENCES public.products(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.product_comments
    ADD CONSTRAINT product_comments_parent_comment_id_fkey FOREIGN KEY (parent_comment_id) REFERENCES public.product_comments(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.product_questions
    ADD CONSTRAINT product_questions_response_user_id_fkey FOREIGN KEY (response_user_id) REFERENCES public.users(id);
...
ALTER TABLE ONLY public.product_questions
    ADD CONSTRAINT product_questions_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id);
...
ALTER TABLE ONLY public.remember_tokens
    ADD CONSTRAINT remember_tokens_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id) ON DELETE CASCADE;
...
GRANT ALL ON FUNCTION public.armor(bytea) TO saleday_user;
...
GRANT ALL ON FUNCTION public.armor(bytea, text[], text[]) TO saleday_user;
...
GRANT ALL ON FUNCTION public.crypt(text, text) TO saleday_user;
...
GRANT ALL ON FUNCTION public.dearmor(text) TO saleday_user;
...
GRANT ALL ON FUNCTION public.decrypt(bytea, bytea, text) TO saleday_user;
...
GRANT ALL ON FUNCTION public.decrypt_iv(bytea, bytea, bytea, text) TO saleday_user;
...
GRANT ALL ON FUNCTION public.digest(bytea, text) TO saleday_user;
...
GRANT ALL ON FUNCTION public.digest(text, text) TO saleday_user;
...
GRANT ALL ON FUNCTION public.encrypt(bytea, bytea, text) TO saleday_user;
...
GRANT ALL ON FUNCTION public.encrypt_iv(bytea, bytea, bytea, text) TO saleday_user;
...
GRANT ALL ON FUNCTION public.gen_random_bytes(integer) TO saleday_user;
...
GRANT ALL ON FUNCTION public.gen_random_uuid() TO saleday_user;
...
GRANT ALL ON FUNCTION public.gen_salt(text) TO saleday_user;
...
GRANT ALL ON FUNCTION public.gen_salt(text, integer) TO saleday_user;
...
GRANT ALL ON FUNCTION public.hmac(bytea, bytea, text) TO saleday_user;
...
GRANT ALL ON FUNCTION public.hmac(text, text, text) TO saleday_user;
...
GRANT ALL ON FUNCTION public.pgp_armor_headers(text, OUT key text, OUT value text) TO saleday_user;
...
GRANT ALL ON FUNCTION public.pgp_key_id(bytea) TO saleday_user;
...
GRANT ALL ON FUNCTION public.pgp_pub_decrypt(bytea, bytea) TO saleday_user;
...
GRANT ALL ON FUNCTION public.pgp_pub_decrypt(bytea, bytea, text) TO saleday_user;
...
GRANT ALL ON FUNCTION public.pgp_pub_decrypt(bytea, bytea, text, text) TO saleday_user;
...
GRANT ALL ON FUNCTION public.pgp_pub_decrypt_bytea(bytea, bytea) TO saleday_user;
...
GRANT ALL ON FUNCTION public.pgp_pub_decrypt_bytea(bytea, bytea, text) TO saleday_user;
...
GRANT ALL ON FUNCTION public.pgp_pub_decrypt_bytea(bytea, bytea, text, text) TO saleday_user;
...
GRANT ALL ON FUNCTION public.pgp_pub_encrypt(text, bytea) TO saleday_user;
...
GRANT ALL ON FUNCTION public.pgp_pub_encrypt(text, bytea, text) TO saleday_user;
...
GRANT ALL ON FUNCTION public.pgp_pub_encrypt_bytea(bytea, bytea) TO saleday_user;
...
GRANT ALL ON FUNCTION public.pgp_pub_encrypt_bytea(bytea, bytea, text) TO saleday_user;
...
GRANT ALL ON FUNCTION public.pgp_sym_decrypt(bytea, text) TO saleday_user;
...
GRANT ALL ON FUNCTION public.pgp_sym_decrypt(bytea, text, text) TO saleday_user;
...
GRANT ALL ON FUNCTION public.pgp_sym_decrypt_bytea(bytea, text) TO saleday_user;
...
GRANT ALL ON FUNCTION public.pgp_sym_decrypt_bytea(bytea, text, text) TO saleday_user;
...
GRANT ALL ON FUNCTION public.pgp_sym_encrypt(text, text) TO saleday_user;
...
GRANT ALL ON FUNCTION public.pgp_sym_encrypt(text, text, text) TO saleday_user;
...
GRANT ALL ON FUNCTION public.pgp_sym_encrypt_bytea(bytea, text) TO saleday_user;
...
GRANT ALL ON FUNCTION public.pgp_sym_encrypt_bytea(bytea, text, text) TO saleday_user;
...
ALTER DEFAULT PRIVILEGES FOR ROLE postgres GRANT ALL ON SEQUENCES TO saleday_user;
...
ALTER DEFAULT PRIVILEGES FOR ROLE postgres GRANT ALL ON TYPES TO saleday_user;
...
ALTER DEFAULT PRIVILEGES FOR ROLE postgres GRANT ALL ON FUNCTIONS TO saleday_user;
...
ALTER DEFAULT PRIVILEGES FOR ROLE postgres GRANT ALL ON TABLES TO saleday_user;
