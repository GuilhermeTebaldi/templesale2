export const itITTranslations: Record<string, string> = {
  ...
  "Alterar local": "Cambia zona",
  "Sua localização atual": "La tua posizione attuale",
  "Última localização salva": "Ultima posizione salvata",
  "Escolha onde procurar": "Scegli dove cercare",
  "Usamos sua localização para mostrar empresas e produtos próximos, somente enquanto esta página estiver aberta.": "Usiamo la tua posizione per mostrarti attività e prodotti vicini, solo mentre questa pagina è aperta.",
  "Usar minha localização": "Usa la mia posizione",
  "Digite a cidade": "Inserisci la città",
  "Buscar produtos e empresas": "Cerca prodotti e attività",
  "O que você procura?": "Cosa stai cercando?",
  "Raio de busca": "Raggio di ricerca",
  "Todas": "Tutte",
  "Ver vitrine": "Vedi vetrina",
  "Buscando empresas próximas…": "Ricerca delle attività vicine…",
  "Nenhuma empresa encontrada nesta região.": "Nessuna attività trovata in questa zona.",
  "Tente outra categoria, amplie o raio ou escolha outra cidade.": "Prova un’altra categoria, amplia il raggio o scegli un’altra città.",
  "Ver mais empresas": "Mostra altre attività",
  "Não foi possível carregar empresas próximas.": "Impossibile caricare le attività vicine.",
  "Este navegador não oferece localização. Escolha uma cidade.": "Questo browser non supporta la posizione. Scegli una città.",
  "Localização imprecisa. Tente novamente ou escolha uma cidade.": "Posizione imprecisa. Riprova o scegli una città.",
  "Localização não autorizada. Escolha uma cidade ou libere a permissão no navegador.": "Posizione non autorizzata. Scegli una città o consenti l’accesso nel browser.",
  "Não foi possível obter sua localização. Tente novamente ou escolha uma cidade.": "Impossibile ottenere la posizione. Riprova o scegli una città.",
  "Editar perfil da empresa": "Modifica profilo aziendale",
  "Dados da empresa": "Dati aziendali",
  "Nome da empresa (obrigatório)": "Nome dell’azienda (obbligatorio)",
  "Categoria da empresa": "Categoria dell’azienda",
  "Descrição da empresa": "Descrizione dell’azienda",
  "Horário de funcionamento": "Orari di apertura",
  "Dados do proprietário": "Dati del proprietario",
  "Nome do proprietário": "Nome del proprietario",
  "WhatsApp da empresa": "WhatsApp aziendale",
  "Localização da empresa": "Posizione dell’azienda",
  "Endereço da empresa": "Indirizzo dell’azienda",
  "Salvar perfil da empresa": "Salva profilo aziendale",
  "Informe o nome da empresa com pelo menos 2 caracteres.": "Inserisci il nome dell’azienda con almeno 2 caratteri.",
  ...
  "Arena de vendas.": "Anfiteatro delle vendite.",
  ...
  "Editar Perfil": "Modifica profilo",
  "Email cadastrado": "Email registrata",
  "Sem email cadastrado": "Nessuna email registrata",
  "Este email nao pode ser alterado.": "Questa email non puo essere modificata.",
  "Ver senha": "Mostra password",
  ...
  "Buscar produtos, categorias ou cidade (ex.: casa em Ardea)...": "Cerca prodotti, categorie o città (es.: casa ad Ardea)...",
  ...
  "Filtrar resultados por produto, categoria ou cidade...": "Filtra risultati per prodotto, categoria o città...",
  ...
  "Limite atingido": "Limite raggiunto",
  "Enviando...": "Invio...",
